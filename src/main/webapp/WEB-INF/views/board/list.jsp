	...
	<c:forEach items="${requestScope.pageList.content}" var="board">
		    <tr onmouseover="this.style.background='#eaeaea'" onmouseout="this.style.background='white'">
		        <td bgcolor="">
		            ...
		            ${board.boardNo}</span></p>
		        </td>
		        <td bgcolor="">
					<p><span style="font-size:9pt;">
					<a href="${pageContext.request.contextPath}/board/read/${board.boardNo}"> 
					  ${board.boardTitle} /  Reply count : <b style="color:red"> ${board.replyList.size()} </b>
					</a>
					</span></p>
		        </td>
		        ...
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            ${board.boardContent}</span></p>
		        </td>
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            ${board.boardImg}</span></p>
		        </td>
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            ${board.boardLikeNo}</span></p>
		        </td>
		    </tr>
    </c:forEach>
	</c:otherwise>
