...
<table align="center" cellpadding="5" cellspacing="2" width="600"
   ...
   <tr>
      ...
      <td width="450" height="20" colspan="3"><span
         style="font-size: 9pt;"><b>${board.bno}</b></span></td>
   </tr>
   <tr>
      <td width="100" height="20">
         <p align="right">
      ...
      <td width="300" height="20"><span style="font-size: 9pt;"><b>${requestScope.board.insertDate}</b></span>
      </td>
      <td width="100" height="20">
         <p align="right">
      ...
      <td width="100" height="20">
         <p>
            <b><span style="font-size: 9pt;"></span>${requestScope.board.readnum}</b>
         </p>
      </td>
   </tr>
   <tr>
      ...
      <td width="450" height="20" colspan="3"><span
         style="font-size: 9pt;"><b>${requestScope.board.subject}</b></span></td>
   </tr>
   <tr>
      ...
      <td width="450" height="200" valign="top" colspan="3"><span
         style="font-size: 9pt;"><b><pre>${requestScope.board.content}</pre></b></span></td>
   </tr>
      ...
      <td height="20" colspan="4" align="center" valign="middle">
         ...
         <form name="requestForm" method="post" id="requestForm">
            <input type=hidden name="bno" value="${board.bno}"> <input
               type=hidden name="password" value="" id="password"> <input
               type=button value="수정하기"> <input type=button value="삭제하기">
...
<%-- <c:forEach items="${board.replyList}" var="reply" varStatus="state">
    ${state.count}순서 / ${reply.rno} = ${reply.content}  / ${reply.insertDate}
      <a
      href="${pageContext.request.contextPath}/reply/delete/${reply.rno}/${board.bno}">삭제</a>
   <p>
</c:forEach>
 --%>
...
<div align=right>
   <span style="font-size: 9pt;">&lt;<a
      href="${pageContext.request.contextPath}/board/list">리스트로 돌아가기</a>&gt;
   </span>
</div>
