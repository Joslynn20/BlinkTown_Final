...
<body>
<form action="${pageContext.request.contextPath}/shop/insertGoods" method="post" enctype="multipart/form-data">
	<section class="main">
		<div class="wrapper">
			<div class="left-col">
				<div class="post">
					<div class="row">
						<div class="col-sm-2 imgUp">
							...
							<label class="btn btn-primary">메인이미지업로드
								<input type="file" class="uploadFile img" name="mainImg" value="Upload Photo" style="width: 0px; height: 0px; overflow: hidden;">
							</label>
						</div>
						<!-- col-2 -->
					</div>
